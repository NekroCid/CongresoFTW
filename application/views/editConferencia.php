			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						...
						<input name="nom" type="text" class="form-control" placeholder="Nombre de la Conferencia" value="<?php echo $conferencia['nombre'] ?>">
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input name="lugar" type="text" class="form-control" placeholder="Sede" value="<?php echo $conferencia['lugar'] ?>">
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input name="fecha" type="date" class="form-control" placeholder="AAAA-MM-DD" id="datepicker" value="<?php echo $conferencia['fecha'] ?>">
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input name="hora" type="time" class="form-control" placeholder="HH:MM" value="<?php echo $conferencia['hora'] ?>">
					</div>
				</div>
			</div>
